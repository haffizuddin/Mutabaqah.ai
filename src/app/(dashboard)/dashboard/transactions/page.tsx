...
import { Plus, Search, Eye, Filter, FileText, Download, RefreshCw, ChevronRight } from 'lucide-react';
            ...
            <div className="divide-y divide-slate-100">
              {filteredTransactions.map((txn) => {
                ...
                return (
                  ...
                  >
                    {/* Avatar */}
                    <div className="hidden sm:flex w-12 h-12 rounded-xl bg-gradient-to-br from-green-400 to-emerald-500 items-center justify-center text-white font-bold shadow-lg shadow-green-500/20">
                    ...
                    <div className="flex items-center gap-2">
                      <Button variant="ghost" size="icon" className="h-9 w-9 text-slate-400 group-hover:text-green-600">
